...
class Twbs3FormTest extends TestCase
{
    ...
    {
        $this->form = new Twbs3Form($this->fw = new Core('phpunit-test'), $this->validator = new Validator($this->fw), new Html($this->fw));
    }
...
TXT;
        ...
        $this->fw->set('POST.twbs3_form', array('_form' => 'twbs3_form') + $data);
