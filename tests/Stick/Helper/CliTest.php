...
class CliTest extends TestCase
{
    ...
    {
        $this->assertEquals(null, $this->cli->getStyle('foo'));
     ...
     */
    public function testWriteln($expected, $line)
    {
    ...
    public function testWrite()
    {
        ...
        $this->cli->write('<error>error foo</error>');
    }
    ...
    public function linesProvider()
    {
        return array(
            ...
            array("\033[37;41merror foo\033[39;49m".PHP_EOL, '<error>error foo</error>'),
        );
    }
