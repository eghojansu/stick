...
class ImageTest extends TestCase
{
    ...
    public function testGetOptions()
    {
        ...
        $this->assertEquals($expected, $this->image->getOptions());
    }
    ...
    public function testSetOptions()
    {
        ...
        $this->assertEquals($expected, $this->image->setOptions(array('image_format' => 'jpg'))->getOptions());
    }

    public function testReset()
    {
        $this->assertSame($this->image, $this->image->reset());
    }
    ...
    {
        $this->image->loadFile(TEST_FIXTURE.'images/original.png');
        $expected = file_get_contents(TEST_FIXTURE.'images/original.txt');

        $this->assertEquals($expected, $this->image->base64());
    }
    ...
    {
        $foo = clone $this->image;
        $imgA = file_get_contents(TEST_FIXTURE.'images/'.$file.'.png');
        $imgB = $this->image->identicon('bar')->overlay($foo->identicon('foo'), $align, $alpha)->dump();
    ...
    {
        $this->image->setOptions(array(
            'captcha_font' => 'Lato-Black.ttf',
            'captcha_font_path' => TEST_FIXTURE.'fonts/',
        ));
        $text = $this->image->captcha();
