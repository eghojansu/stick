...
class ValidatorTest extends TestCase
{
    ...
    {
        $this->assertSame($this->validator, $this->validator->addRule(new CommonRule()));
    }
    ...
    public function testValidateException()
    {
        ...
        $this->expectExceptionMessage('Rule "foo" not exists');
    ...
    public function validateProvider()
    {
        return array(
            ...
            array(
                array('foo' => 'identicalto:bar,string'),
                array('foo' => 'bar'),
                null,
                array('foo' => 'baz'),
            ...
            array(
                array('foo' => 'notidenticalto:bar,string'),
                array('foo' => 'baz'),
                null,
                array('foo' => 'bar'),
