...
<div class="form-group row"><div class="ml-auto col-sm-10"><div class="form-check"><input type="checkbox" name="twbs4_form[checkbox]" id="twbs4_form_checkbox" class="form-check-input" checked value="checkbox"><label class="form-check-label" for="twbs4_form_checkbox">Checkbox</label></div></div></div>
<div class="form-group row"><div class="ml-auto col-sm-10"><div class="form-check"><input type="radio" name="twbs4_form[radio]" id="twbs4_form_radio" class="form-check-input" checked value="radio"><label class="form-check-label" for="twbs4_form_radio">Radio</label></div></div></div>
...
<div class="form-group row"><label for="twbs4_form_choice2" class="col-form-label col-sm-2">Choice2</label><div class="col-sm-10"><div><div class="form-check"><input name="twbs4_form[choice2]" id="twbs4_form_choice2_0" checked class="form-check-input" type="radio" value="3"><label class="form-check-label" for="twbs4_form_choice2_0">Three</label></div><div class="form-check"><input name="twbs4_form[choice2]" id="twbs4_form_choice2_1" class="form-check-input" type="radio" value="4"><label class="form-check-label" for="twbs4_form_choice2_1">Four</label></div></div></div></div>
<div class="form-group row"><label for="twbs4_form_choice3" class="col-form-label col-sm-2">Choice3</label><div class="col-sm-10"><div><div class="form-check"><input name="twbs4_form[choice3][]" id="twbs4_form_choice3_0" checked class="form-check-input" type="checkbox" value="5"><label class="form-check-label" for="twbs4_form_choice3_0">Five</label></div><div class="form-check"><input name="twbs4_form[choice3][]" id="twbs4_form_choice3_1" class="form-check-input" type="checkbox" value="6"><label class="form-check-label" for="twbs4_form_choice3_1">Six</label></div></div></div></div>
