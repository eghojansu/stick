...
class Twbs3FormBuilder extends DivFormBuilder
{
    ...
    protected function inputRadio(Field $field): string
    {
        ...
        return Util::tag('div', $attr, true, parent::inputRadio($field));
    }
    ...
    protected function inputCheckbox(Field $field): string
    {
        ...
        return Util::tag('div', $attr, true, parent::inputCheckbox($field));
    }
    ...
    {
        return $errors ? Util::tag('span', array('class' => 'help-block'), true, implode(', ', $errors)) : '';
    }
