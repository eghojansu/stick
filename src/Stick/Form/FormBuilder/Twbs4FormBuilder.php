...
class Twbs4FormBuilder extends Twbs3FormBuilder
{
    ...
    {
        $wrapperAttr = $field->wrapper_attr;
        ...
        $label = Element::tag('label', $labelAttr, true, $field->label);

        return Element::tag('div', $wrapperAttr + $wrapperDefault, true, $radio.$label);
    }
    ...
    protected function inputCheckbox(Field $field): string
    {
        ...
        return Element::tag('div', $wrapperAttr + $wrapperDefault, true, $checkbox.$label);
    }
    ...
    {
        return $errors ? Element::tag('div', array('class' => 'invalid-feedback'), true, implode(', ', $errors)) : '';
    }
